...
public class LocationPlugin : MonoBehaviour
{
    ...
    private AndroidUnityCallback _androidUnityCallback;
    ...
    {
        _androidUnityCallback = new AndroidUnityCallback();
        pluginJavaClass.Call("setCallBackListener", _androidUnityCallback);
    }
